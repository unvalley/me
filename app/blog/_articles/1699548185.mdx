export const metadata = {
  ...
  date: "2023-11-10",
  description: "I recommend using strictest.json found in tsconfig/bases for your tsconfig.json",
  tags: ["TypeScript","english"],
  draft: false,
}
...
Setting up tsconfig.json appropriately should be done before using linters such as [typescript-eslint](https://typescript-eslint.io) or [biome](https://biomejs.dev).
