...
const navigation = [
  { name: "Articles", href: "/detached/articles" },
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          >
            ...
            <div className="w-6 h-5 flex flex-col justify-between">
              <span
                className={`block h-px bg-black transition-all duration-300 ${isMobileMenuOpen ? "rotate-45 translate-y-2" : ""}`}
              />
              <span
                className={`block h-px bg-black transition-all duration-300 ${isMobileMenuOpen ? "opacity-0" : ""}`}
              />
              <span
                className={`block h-px bg-black transition-all duration-300 ${isMobileMenuOpen ? "-rotate-45 -translate-y-2" : ""}`}
              />
