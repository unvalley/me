---
title: TypeScript で DDD を学ぶための OSS 紹介
date: '2022-05-05'
tags: ['typescript', 'ddd']
draft: false
...
About にあるように，TypeScript で，DDD で作った Hacker news Like な WebApp です
．

README を参照すると Backend は，以下が使われています．
...
- [Clean Architecture 達人に学ぶソフトウェアの構造と設計](https://amzn.to/3C78uw4)
