...
${mdxContent}`
    ...
    console.log(`2. Remove the old 'data/blog' directory when you're satisfied with the migration`)
    console.log(`3. Update any other components that reference the old content structure`)
